...
urlpatterns = [
    ...
    path('super-settings/set-default-master/', super_setting_views.set_default_master),
    ...
    path('coming-soon/', coming_soon_views.coming_soon_list_create),
    path('coming-soon/<int:pk>/', coming_soon_views.coming_soon_detail),
